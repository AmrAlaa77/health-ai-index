...
const HERO_RING = 'https://d64gsuwffb70l.cloudfront.net/6a1bff16eb3a4753d1d1427d_1780343218119_9957a1f1.png';
      ...
      >
        ...
        <div>
          ...
          <p className="mt-7 text-lg sm:text-xl text-slate-300 max-w-xl leading-relaxed">
            Not just another wearable. AURION fuses a precision sensor ring with a living
        ...
        {/* Ring + sphere render (static glow — no heavy spin/float loops) */}
        <div className="relative flex items-center justify-center">
          ...
          <div className="relative group">
            <img
              src={HERO_RING}
              alt="AURION ONE ring floating above a chrome sphere"
              className="relative z-10 w-[22rem] sm:w-[28rem] rounded-[2.5rem] shadow-2xl shadow-teal-500/20 transition-transform duration-700 group-hover:scale-[1.03]"
            />
