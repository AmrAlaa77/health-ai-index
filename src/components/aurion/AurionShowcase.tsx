...
const RING_MACRO = 'https://d64gsuwffb70l.cloudfront.net/6a1bff16eb3a4753d1d1427d_1780343270802_1d237196.jpg';
      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-8">
        ...
        >
          <div className="relative overflow-hidden rounded-[2.5rem] border border-white/10">
            <img src={RING_MACRO} alt="AURION ring macro detail" className="w-full h-[24rem] object-cover" />
